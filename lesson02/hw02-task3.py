...
Выходные данные
Нужно вывести «YES», если билет с номером N счастливый и «NO» в противном
случае.
"""
n = int(input("Введите любое целое число [0:999999]"))
if n not in range(10**6):
    print("Число должно быть целым в диапазоне [0:999999]")
    exit()
str = f"{n:06}" 
print("Номер билета -", str)
if int(str[0:3]) == int(str[3:6]):
    print("YES")
else:
    print("NO")
